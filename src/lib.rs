...
pub use WrenErrorType::*;
pub use WrenInterpretResult::*;
pub use WrenType::*;

/// The Wren major semantic version number
pub const WREN_VERSION_MAJOR: c_int = 0;

/// The Wren minor semantic version number
pub const WREN_VERSION_MINOR: c_int = 2;

/// The Wren patch semantic version number
pub const WREN_VERSION_PATCH: c_int = 0;

pub const WREN_VERSION_STRING: &str = "0.2.0";

/// A monotonically increasing numeric representation of the version number. Use
/// this if you want to do range checks over versions.
pub const WREN_VERSION_NUMBER: c_int =
...
pub struct WrenConfiguration {
    ...
    pub reallocateFn: Option<WrenReallocateFn>,
    ...
    /// above.
    pub resolveModuleFn: Option<WrenResolveModuleFn>,
    ...
    pub loadModuleFn: Option<WrenLoadModuleFn>,
    ...
    pub bindForeignMethodFn: Option<WrenBindForeignMethodFn>,
    ...
    pub bindForeignClassFn: Option<WrenBindForeignClassFn>,

    /// The callback Wren uses to display text when `System.print()` or the other
    /// related functions are called.
    ///
    /// If this is `NULL`, Wren discards any printed text.
    pub writeFn: Option<WrenWriteFn>,
    ...
    /// errors.
    pub errorFn: Option<WrenErrorFn>,
...
impl Default for WrenConfiguration {
    fn default() -> WrenConfiguration {
        unsafe { MaybeUninit::<WrenConfiguration>::zeroed().assume_init() }
    }
}
...
extern "C" {
    ...
    pub fn wrenCall(vm: *mut WrenVM, handle: *mut WrenHandle) -> WrenInterpretResult;
    ...
    pub fn wrenGetUserData(vm: *mut WrenVM) -> *const c_void;

    /// Sets user data associated with the WrenVM.
    pub fn wrenSetUserData(vm: *mut WrenVM, userData: *const c_void);
}
